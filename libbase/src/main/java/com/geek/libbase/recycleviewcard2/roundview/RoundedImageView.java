...
package com.geek.libbase.recycleviewcard2.roundview;
...
public class RoundedImageView extends ImageView {
  ...
  public static final String TAG = "StackRoundedImageView";
  ...
  public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
    ...
    TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.StackRoundedImageView, defStyle, 0);

    int index = a.getInt(R.styleable.StackRoundedImageView_android_scaleType, -1);
    if (index >= 0) {
   ...
   * width.
   *
   * @return if this {@linkStackRoundedImageView} is set to oval.
   */
   ...
   *
   * @param oval if this {@linkStackRoundedImageView} should be oval.
   */
  ...
  /**
   * Set whether the {@linkStackRoundedImageView} should round the background drawable according to
